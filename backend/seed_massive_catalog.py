...
from app.services.opml_importer import fetch_and_import_opml_url

# 🌐 List of Public Remote OPML Directories to auto-import over HTTP
REMOTE_OPML_DIRECTORIES = [
    {
    ...
    {
        "url": "https://raw.githubusercontent.com/plenaryapp/awesome-rss-feeds/master/recommended/with_category/Cyber%20security.opml",
        "category": "Technologie"
    },
    {
    ...
    {
        "url": "https://raw.githubusercontent.com/plenaryapp/awesome-rss-feeds/master/recommended/with_category/Environment.opml",
        "category": "Science"
    }
]

# 📚 Extended Curated Dataset (200+ Verified Feeds across all main topics)
MASSIVE_FEEDS = [
    # 🇨🇭 SUISSE & ROMANDIE
    {
    ...
    },
    {
        ...
        "site_url": "https://www.tagesanzeiger.ch",
        "title": "Tages-Anzeiger",
        "description": "Grand quotidien suisse alémanique basé à Zurich.",
        "icon_url": "https://www.google.com/s2/favicons?domain=tagesanzeiger.ch&sz=128",
        "category": "Suisse",
        "language": "de",
        "country": "CH",
        "is_full_text": False,
        "is_verified": True,
        "tags": ["#suisse", "#allemand", "#presse"]
    },

    # 🌍 MONDE & PRESSE EUROPÉENNE
    {
    ...
    },
    {
        ...
        "title": "Deutsche Welle (Français)",
        "description": "Le service d'information international de l'Allemagne en langue française.",
        ...
        "is_full_text": True,
        "is_verified": True,
        "tags": ["#monde", "#international", "#actualité"]
    },

    # 🚀 TECHNOLOGIE, CODE & OPEN-SOURCE
    {
        "url": "https://next.ink/feed/",
        "site_url": "https://next.ink",
        "title": "Next.ink (Tech & Numérique)",
        "description": "Média indépendant spécialisé dans le numérique, les libertés et l'informatique.",
    ...
    },
    {
        ...
        "title": "DEV Community",
        "description": "La plateforme communautaire mondiale de partage d'articles pour développeurs et ingénieurs software.",
        "icon_url": "https://www.google.com/s2/favicons?domain=dev.to&sz=128",
        "category": "Technologie",
        "language": "en",
        "country": "US",
        "is_full_text": True,
        "is_verified": True,
        "tags": ["#technologie", "#développement", "#code", "#open_source"]
    },
    {
        "url": "https://www.phoronix.com/phoronix-rss.php",
        "site_url": "https://www.phoronix.com",
        "title": "Phoronix (Linux & Hardware)",
        "description": "Le site d'actualité et de benchmarks Linux, kernel et hardware de référence.",
        "icon_url": "https://www.google.com/s2/favicons?domain=phoronix.com&sz=128",
        "category": "Technologie",
        "language": "en",
        "country": "US",
        "is_full_text": True,
        "is_verified": True,
        "tags": ["#technologie", "#linux", "#open_source", "#hardware"]
    },
    {
    ...
    },
    {
        ...
        "description": "Le blog d'investigation en cybersécurité et cybercriminalité rédigé par Brian Krebs.",
        "icon_url": "https://www.google.com/s2/favicons?domain=krebsonsecurity.com&sz=128",
        "category": "Technologie",
        "language": "en",
        "country": "US",
        "is_full_text": True,
        "is_verified": True,
        "tags": ["#cybersécurité", "#technologie", "#hacker"]
    },
    {
        "url": "https://feeds.feedburner.com/TheHackersNews",
        "site_url": "https://thehackersnews.com",
        "title": "The Hacker News",
        "description": "Le canal d'actualité indépendant mondial sur les vulnérabilités et la sécurité informatique.",
        "icon_url": "https://www.google.com/s2/favicons?domain=thehackersnews.com&sz=128",
        "category": "Technologie",
        "language": "en",
        "country": "US",
        "is_full_text": False,
    ...
    # 🔬 SCIENCE & ENVIRONNEMENT
    {
        ...
        "title": "Nature News",
        "description": "Les découvertes scientifiques majeures publiées dans la prestigieuse revue Nature.",
    ...
    },
    {
        ...
        "site_url": "https://www.futura-sciences.com",
        "title": "Futura Sciences",
        "description": "Le média de décodage des actualités scientifiques, technologiques et environnementales.",
        "icon_url": "https://www.google.com/s2/favicons?domain=futura-sciences.com&sz=128",
        "category": "Science",
        "language": "fr",
        "country": "FR",
        "is_full_text": False,
        "is_verified": True,
        "tags": ["#science", "#innovation", "#espace"]
    }
]

async def seed_massive_catalog_async():
    print("[Catalogue Massive Seed] Initialisation de la base de données...")
    init_db()

    # 1. Import Remote Public OPML Directories over HTTP
    for dir_info in REMOTE_OPML_DIRECTORIES:
        try:
            await fetch_and_import_opml_url(dir_info["url"], default_category=dir_info["category"])
        except Exception as e:
            print(f"[OPML Auto-Seed Note for {dir_info['url']}]: {e}")
    ...
    for feed_info in MASSIVE_FEEDS:
        ...
        try:
            ...
            print(f"[Catalog Direct Add Error for {feed_info.get('url')}]: {err}")

    # 3. Clean up dead/obsolete feeds that failed or were removed
    try:
        conn = get_db_connection()
        cursor = conn.cursor()
        cursor.execute("SELECT id, url FROM catalog_feeds WHERE is_verified = 1")
        rows = cursor.fetchall()
        valid_urls = {f["url"] for f in MASSIVE_FEEDS}
        deleted_count = 0
        for r in rows:
            # Keep remote opml feeds or valid feeds
            if r["url"] not in valid_urls and "heidi.news" in r["url"]:
...
def seed_catalog():
    """Synchronous wrapper for seed_massive_catalog_async."""
    try:
        asyncio.run(seed_massive_catalog_async())
    except Exception as e:
